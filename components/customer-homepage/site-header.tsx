...
import { AccountMenu } from "@/components/customer-homepage/account-menu"
...
export function CustomerHeader({ profile }: { profile: HeaderProfile | null }) {
  return (
...
export function RestaurantOwnerHeader({
  profile,
}: {
